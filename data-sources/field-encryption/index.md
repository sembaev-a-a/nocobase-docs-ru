...
Если плагин включен в дочернем приложении, ключ хранится по пути:
...
**Требования к файлу application key:**
...
Зашифрованные поля поддерживают только следующие операторы фильтрации:
